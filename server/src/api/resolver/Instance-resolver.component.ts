...
export class InstanceResolver {
    ...
    async getAll(
        ...
        const criteria = this.applyInstanceFilterArgumentToCriteria({}, args as ResolverInstanceFilterArgumentsInterface);
    ...
    protected applyInstanceFilterArgumentToCriteria(criteria: any, args: ResolverInstanceFilterArgumentsInterface): object {
        if (args.name) {
