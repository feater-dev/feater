...
import {ProjectLister} from './project-lister.component';
import {ProjectModelToTypeMapper} from './project-model-to-type-mapper.component';
import {DefinitionModelToTypeMapper} from './definition-model-to-type-mapper.component';
import {AssetModelToTypeMapper} from './asset-model-to-type-mapper.component';
import {DefinitionLister} from './definition-lister.component';
import {AssetLister} from './asset-lister.component';
...
export class ProjectsResolver {
    ...
    public async create(@Args() createProjectInput: CreateProjectInputTypeInterface): Promise<ProjectTypeInterface> {
    ...
    protected applyProjectFilterArgumentToCriteria(criteria: any, args: ResolverProjectFilterArgumentsInterface): object {
        if (args.name) {
    ...
    // TODO Move somewhere else.
    protected applyAssetFilterArgumentToCriteria(criteria: any, args: ResolverAssetFilterArgumentsInterface): object {
        if (args.id) {
