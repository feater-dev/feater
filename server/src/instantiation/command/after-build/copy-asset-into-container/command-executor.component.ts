...
import {
    AssetHelper,
    AssetUploadPathsInterface,
} from '../../../../persistence/helper/asset-helper.component';
...
@Injectable()
export class CopyAssetIntoContainerCommandExecutorComponent
